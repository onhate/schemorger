...
<code>breadcrumb</code> may be used. We recommend explicit declaration if these properties are specified, but if they are found outside of an itemscope, they will be assumed to be about the page
...
public class WebPage extends CreativeWork {
	...
	private com.texelz.schemorger.definition.Link relatedLink;
	private Object reviewedBy;
	private com.texelz.schemorger.definition.Link significantLink;
	 ...
	 */
	public com.texelz.schemorger.definition.Link getRelatedLink() {
		return this.relatedLink;
	}
	public void setRelatedLink(com.texelz.schemorger.definition.Link relatedLink) {
	...
	/**
	 * One of the more significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most. Supercedes <a href="significantLinks">significantLinks</a>.
	 */
	public com.texelz.schemorger.definition.Link getSignificantLink() {
		return this.significantLink;
	}
	public void setSignificantLink(com.texelz.schemorger.definition.Link significantLink) {
