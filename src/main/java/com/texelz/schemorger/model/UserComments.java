...
public class UserComments extends UserInteraction {
	...
	private com.texelz.schemorger.definition.Link replyToUrl;
	/**
	 ...
	 */
	public com.texelz.schemorger.definition.Link getReplyToUrl() {
		return this.replyToUrl;
	}
	public void setReplyToUrl(com.texelz.schemorger.definition.Link replyToUrl) {
